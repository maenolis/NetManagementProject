...
<script src="/NetManagementProject/lib/js/companyUsers.js"></script>
<title>Users Per Company</title>
</head>
<body>
	...
	<script>
		var chart = new drawChart(<%out.print(session.getAttribute("companyUsers"));%>);

...
public class BatteryDataProcessor {
	 ...
	 */
	public static HashMap<String, Float> getLowLevels(HashMap<String, ArrayList<Object>> batteryMap) {
	 ...
	 * @return the float[]
	 */
	public static Float[] convertToPercentages(HashMap<String, Float> dateMap, int size) {
	 ...
	 */
	public static String getStringArrayString(Object[] items){
	    String result = "[";
